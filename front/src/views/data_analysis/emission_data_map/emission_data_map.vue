<template>
    <div id="chart-panel" style="width: calc(100%);height:calc(80vh); margin: 0 auto;">
    </div>
        ...
        initChart() {
            ...
            for (var i = 0; i < mapData.length; i++) {
                ...
                for (var j = 0; j < mapData[i].length; j++) {
                    this.barData[i].push(mapData[i][j].value);
                    this.categoryData[i].push(mapData[i][j].name);
                }
            }
            ...
            echarts.registerMap('china', this.uploadedDataURL);
                ...
                option.options.push({
                    ...
                    series: [
                        ...
                        },
                        {
                            ...
                            data: convertData(
                                mapData[n].sort((a, b) => b.value - a.value).slice(0, 20)
                            ),
                            symbolSize(val) {
                                return val[2] / 10;
                            },
